...
const api1 = {
   PUBLIC_ROOT: "http://kgat.srcoesugs.edu.ng/api/v1",
   ROOT: "http://kgat.srcoesugs.edu.ng/api/v1",
   ROOT_ADMIN: "http://kgat.srcoesugs.edu.ng/api/v1",
   AUTH_ADMIN: "http://kgat.srcoesugs.edu.ng/api/v1/admin/login",
